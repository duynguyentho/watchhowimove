    ...
    <header className={clsx("bg-primaryBg shadow-theme z-10", className)}>
      <nav className="mx-auto container flex items-center justify-between py-4 px-4" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="">
            {/*<Image width={100} height={100} src={Logo} alt="nothing" />*/}
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 gap-3.5 ml-5">
          <Link href="/blog" className="text-sm font-semibold leading-6">
            Blogs
          </Link>
        </PopoverGroup>
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Link href="/about-me" className="text-sm font-semibold leading-6">
            Who am I
          </Link>
        </PopoverGroup>
      </nav>
